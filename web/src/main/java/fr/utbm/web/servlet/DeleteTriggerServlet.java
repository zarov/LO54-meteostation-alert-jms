...
public class DeleteTriggerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int triggerId = Integer.parseInt(request.getParameter("id"));
        int sensorId = Integer.parseInt(request.getParameter("sensorId"));

        TriggerService ts = new TriggerService();
        ts.deleteTrigger(triggerId);
        //request.setAttribute("id",sensorId);
        //RequestDispatcher dis=request.getRequestDispatcher("TriggerListServlet");
        //dis.forward(request,response);
        response.sendRedirect("TriggerListServlet?id="+sensorId);
    }
